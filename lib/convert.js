...
Converter = {
  ...
  convert: function (json) {
    ...
    var contactName = json.info.contact.name ? json.info.contact.name : "";
    var contactEmail = json.info.contact.email ? json.info.contact.email : "";
    var contactDescription = json.info.contact ? "\nFor more information, contact: " + contactName + " " + contactEmail : ""; 
    var licenseName = json.info.license.name ? json.info.license.name : "";
    var licenseUrl = json.info.license.url ? json.info.license.url : "";
    var licenseDescription = licenseName && licenseUrl ? "\nLicense: " + licenseName + " " + licenseUrl : ""

    var forCollectionDescription = json.info.description + contactDescription + licenseDescription;
    console.log(forCollectionDescription);
    this.collection.describe(forCollectionDescription, "text/markdown");
