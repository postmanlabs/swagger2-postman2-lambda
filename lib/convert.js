...
Converter = {
  ...
  convert: function (json) {
    ...
    var contactName = json.info.contact.name || "";
    var contactEmail = json.info.contact.email || "";
    var contactDescription = json.info.contact ? "\nFor more information, contact: " + contactName + " " + contactEmail : ""; 
    
    var licenseName = json.info.license.name || "";
    var licenseUrl = json.info.license.url || "";
